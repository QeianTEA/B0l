...
func _ready():
	...
	var tower_grid = grid_scene.instantiate()
	add_child(tower_grid)
	tower_grid.position = Vector2(120, 192)  # Adjust position as needed
	...
	var grid_container = tower_grid.get_node("Control/GridContainer")
